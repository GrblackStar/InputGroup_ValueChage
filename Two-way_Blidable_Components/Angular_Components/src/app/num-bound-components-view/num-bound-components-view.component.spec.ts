...
import { IgxButtonModule, IgxRippleModule, IgxInputGroupModule, IgcFormsModule, IgxSliderModule } from 'igniteui-angular';
...
describe('NumBoundComponentsViewComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      imports: [ NoopAnimationsModule, FormsModule, IgxButtonModule, IgxRippleModule, IgxInputGroupModule, IgcFormsModule, IgxSliderModule ]
    })
    .compileComponents();
  });
